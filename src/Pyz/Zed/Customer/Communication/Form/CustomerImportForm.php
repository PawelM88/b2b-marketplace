 ...
 */
class CustomerImportForm extends AbstractType
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    public const BLOCK_PREFIX = 'customerImport';
    ...
    protected function addUploadFileField(FormBuilderInterface $builder): void
    {
        $builder->add(static::FIELD_FILE_UPLOAD, FileType::class, [
            'label' => 'Select File with customers to import',
            'required' => true,
            'attr' => [
     ...
     *
     * @return \Pyz\Zed\Customer\Communication\File\UploadedFile
     */
