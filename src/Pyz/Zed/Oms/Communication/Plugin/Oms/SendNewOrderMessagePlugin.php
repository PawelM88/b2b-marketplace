 ...
 */
class SendNewOrderMessagePlugin extends AbstractPlugin implements CommandByOrderInterface
{
    /**
     * {@inheritDoc}
     * - Sends new order creation message
     *
     * @api
     *
    ...
    {
        return NewOrderMailTypeBuilderPlugin::MAIL_TYPE;
    }
}
