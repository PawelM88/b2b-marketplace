...
use Spryker\Zed\CompanyUnitAddress\Persistence\Propel\Mapper\CompanyUnitAddressMapper as SprykerCompanyUnitAddressMapper;

class CompanyUnitAddressMapper extends SprykerCompanyUnitAddressMapper implements CompanyUnitAddressMapperInterface
{
    /**
    ...
    public function mapCompanyUnitAddressTransferFromCombinedCsvFileToCompanyUnitAddressEntity(
        ...
        return $companyUnitAddressEntity->fromArray($companyUnitAddressTransfer->modifiedToArray());
    }
     ...
     */
    public function mapCompanyUnitAddressEntityToCompanyUnitAddressTransferFromCombinedCsvFile(
        SpyCompanyUnitAddress $companyUnitAddressEntity,
        CompanyUnitAddressTransfer $companyUnitAddressTransfer,
    ): CompanyUnitAddressTransfer {
        return $companyUnitAddressTransfer->fromArray($companyUnitAddressEntity->toArray());
    }
    ...
    public function mapAddressToBusinessUnitEntityTransferToAddressToBusinessUnitEntity(
        ...
        return $companyUnitAddressToCompanyBusinessUnitEntity->fromArray(
            $companyUnitAddressToCompanyBusinessUnitEntityTransfer->modifiedToArray(),
        );
    }
}
